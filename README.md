...
![Elasticsearch](https://img.shields.io/badge/Elastic-%23005571.svg?style=for-the-badge&logo=elasticsearch&logoColor=white)
...
- **[envcheck](https://github.com/caglareker/envcheck)** — Small Go CLI to check `.env` files against a template
- **[dsa-java](https://github.com/caglareker/dsa-java)** — Java solutions to common data structure and algorithm problems
